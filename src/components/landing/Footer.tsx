        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="mb-6">
              ...
              />
              <p className="text-steel text-sm mt-2">Distribuidora Mayorista</p>
            </div>

            <p className="text-steel text-sm leading-relaxed">
              Distribución mayorista de materiales eléctricos, iluminación,
              ferretería y sanitarios para comercios de todo el país.
            </p>
          </div>
              ...
              <li>
                <div className="flex items-start gap-3 text-steel">
                  ...
                  <span className="text-sm">
                    Av. 122 esquina 84, Berisso, Buenos Aires
                  </span>
                </div>
              </li>
            </ul>
